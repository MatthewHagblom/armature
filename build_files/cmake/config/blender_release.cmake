...
if(NOT APPLE)
  ...
  set(_is_linux_arm64_target OFF)
  if(WIN32)
  ...
  elseif(UNIX)
    # `CMAKE_SYSTEM_PROCESSOR` isn't set yet here either, so query the host
    # (Linux AArch64 builds are native, not cross-compiled).
    cmake_host_system_information(RESULT _host_arch QUERY OS_PLATFORM)
    if(_host_arch STREQUAL "aarch64")
      set(_is_linux_arm64_target ON)
    endif()
    unset(_host_arch)
  endif()
  if(NOT _is_win32_arm64_target)
    ...
    # AMD HIP and Intel oneAPI toolchains are not available for Linux AArch64.
    if(NOT _is_linux_arm64_target)
